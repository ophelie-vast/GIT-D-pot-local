...
check.addEventListener("click", function verif(event)
{
    ...
    {
        document.getElementById("erreurDate").textContent = "Veuillez saisir votre date de naissance !";
    ...
    else if (!birth.test(date))
    {
        ...
        document.getElementById("erreurDate").style.color = 'orange';
        event.preventDefault();
    }
    else
    {
    ...
    {
        document.getElementById("erreurCP").textContent = "Veuillez saisir votre code postal !";
    ...
    else if (!cp.test(codepostal))
    {
        ...
        document.getElementById("erreurCP").style.color = 'orange';
        event.preventDefault();
    }
    else
    {
    ...
    {
        document.getElementById("erreurAdresse").textContent = "Veuillez saisir votre adresse !";
    ...
    else if (!adr.test(adresse)) 
    {
        ...
        document.getElementById("erreurAdresse").style.color = 'orange';
        event.preventDefault();
    }
    else 
    {
    ...
    {
        document.getElementById("erreurVille").textContent = "Veuillez saisir votre ville !";
    ...
    {
        document.getElementById("erreurQuest").textContent = "Veuillez saisir votre question !";
